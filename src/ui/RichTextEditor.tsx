...
export default function RichTextEditor({ value, onChange, placeholder = 'Add notes...', onFocus }: Props): ReactElement {
    ...
    const toggleBold = useCallback(() => {
        ...
        if (selectionStart === selectionEnd) {
            ...
            // First tap starts bold typing mode, second tap closes it.
            if (typingBold) {
        ...
        setTypingBold(false);
    }, [selectionStart, selectionEnd, typingBold, value, onChange]);
    ...
    const isBoldActive = typingBold || isBoldSelected;
    ...
    return (
        <View style={styles.container}>
            <View style={styles.toolbar}>
                <Pressable
                    onPress={toggleBold}
                    style={({ pressed }) => [styles.toolButton, isBoldActive && styles.toolButtonActive, pressed && styles.pressed]}
                >
                    <FontAwesome6 name="bold" size={18} color={isBoldActive ? colors.accent : colors.textMuted} />
                </Pressable>
            </View>
